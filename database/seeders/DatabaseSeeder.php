...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call([
            ...
            ChartOfAccountPermissionSeeder::class,
            ChartOfAccountImportPermissionSeeder::class,
            CustomerPermissionSeeder::class,
            CustomerImportPermissionSeeder::class,
            CustomerCategoryPermissionSeeder::class,
            GoodsReceiptPermissionSeeder::class,
            InventoryAdjustmentPermissionSeeder::class,
            InventoryBalancePermissionSeeder::class,
            ProductPermissionSeeder::class,
            ProductImportPermissionSeeder::class,
            PurchaseInvoicePermissionSeeder::class,
            SupplierPermissionSeeder::class,
            SupplierImportPermissionSeeder::class,
            SupplierCategoryPermissionSeeder::class,
